use crate::xhc::device_manager::descriptor::{structs::{configuration_descriptor::{ConfigurationDescriptor, CONFIGURATION_DESCRIPTOR_TYPE}, endpoint_descriptor::EndpointDescriptor, hid_descriptor::HidDescriptor, interface_descriptor::{InterfaceDescriptor, INTERFACE_DESCRIPTOR_TYPE}}, Descriptor};
...
impl Iterator for DescriptorSequence {
    ...
    fn next(&mut self) -> Option<Self::Item> {
        ...
        let ptr = unsafe {
            self.descriptor_ptr.add(self.index)
        };
